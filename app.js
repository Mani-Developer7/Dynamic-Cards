...
const renderProducts = (productList = Data.products) => {
    Container.innerHTML = "";

    productList.forEach(element => {     
        const CardUi = `
            <div class="product-card">
                <img src="${element.images}" alt="${element.name}" class="product-image">
                <div class="product-info">
                    ...
                    <div class="product-rating">
                        <span class="stars">⭐️ ${element.rating.toFixed(1)}</span>
                    </div>
...
document.getElementById("BtnElectronics").addEventListener("click", function(e) {
    e.preventDefault();
    const electronics = Data.products.filter(El => El.category_id === 1);
